...
const dropdownTemplate1 = (rowData, { rowIndex }) => <p >{rowData.vouchername}</p>
...
<Column field="vouchername" header="Vouchername" body={dropdownTemplate1} filter={selectedFilterFields.includes("vouchername")} hidden={selectedHideFields?.includes("vouchername")}  style={{ minWidth: "8rem" }} />
