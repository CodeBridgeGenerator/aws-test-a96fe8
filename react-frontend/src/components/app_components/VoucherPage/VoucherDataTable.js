...
const inputTextareaTemplate6 = (rowData, { rowIndex }) => <p >{rowData.Termsandcondition}</p>
...
<Column field="Termsandcondition" header="Termsandcondition" body={inputTextareaTemplate6} filter={selectedFilterFields.includes("Termsandcondition")} hidden={selectedHideFields?.includes("Termsandcondition")}  sortable style={{ minWidth: "8rem" }} />
